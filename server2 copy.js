...
// async function navigateToTemplate(page) {
//     try {
//         console.log("naviagating to template");
...
//       console.log("Wait for template grid to be visible with retry");
...
async function test(email, password, data) {
...
app.post("/getData", async (req, res) => {
  ...
  const data = [
    {
        title:"New Title Crop Top",
        templateName:"Women’s crop top",
        catalogue:"AS Color 4062",
        store:"",
        category:"Cropped T-Shirt"
    },
    {
        title:"New Title Hoodie",
        templateName:"Unisex Hoodie",
        catalogue:"Blend Hoodie Gildan 18500",
        store:"",
        category:"Hoodie"
    }
  ]
  ...
  try {
    await test(email, password, data);
